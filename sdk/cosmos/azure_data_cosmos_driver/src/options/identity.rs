...
///
/// This is the effective user agent that will be included in all requests
/// from this environment.
#[derive(Clone, Debug, Default, PartialEq, Eq)]
pub struct UserAgent(String);

impl UserAgent {
    /// Creates a new user agent from the provided string.
...
mod tests {
    ...
    #[test]
    fn user_agent_creation() {
        let ua = UserAgent::new("my-app/1.0");
        assert_eq!(ua.as_str(), "my-app/1.0");
    }
