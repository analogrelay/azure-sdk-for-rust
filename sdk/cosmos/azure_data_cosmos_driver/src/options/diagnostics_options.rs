...
///     .max_summary_size_bytes(16 * 1024)  // 16 KB
...
impl DiagnosticsOptionsBuilder {
    ...
    pub fn max_summary_size_bytes(mut self, size: usize) -> Self {
    ...
    pub fn default_verbosity(mut self, verbosity: DiagnosticsVerbosity) -> Self {
...
mod tests {
    ...
    fn custom_values() {
        let options = DiagnosticsOptionsBuilder::new()
            .max_summary_size_bytes(16 * 1024)
            .default_verbosity(DiagnosticsVerbosity::Summary)
            .build()
            .unwrap();
    ...
    fn max_summary_size_too_small() {
        let result = DiagnosticsOptionsBuilder::new()
            .max_summary_size_bytes(2 * 1024) // 2 KB, below minimum
            .build();
